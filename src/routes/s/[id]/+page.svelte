<script lang="ts">
	...
	let selectedModels = ['static-model']; // Static model for shared chats
	...
	const loadSharedChat = async () => {
		...
		if (isFrontendOnly) {
			console.log('🔧 Frontend-only mode: skipping shared chat validation');

			// Use local storage settings for frontend-only mode
			...
			// Set mock data for frontend-only mode
			models.set([
				{
					id: 'custom-api',
					name: 'Custom API',
		...
		// Original backend validation logic
