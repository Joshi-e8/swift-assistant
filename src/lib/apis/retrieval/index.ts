...
export const processYoutubeVideo = async (token: string, url: string) => {
	// Static implementation - return mock YouTube processing result
	console.log('✅ Static processYoutubeVideo called with:', url);
	return {
		status: 'success',
...
export const processWeb = async (token: string, collection_name: string, url: string) => {
	// Static implementation - return mock web processing result
	console.log('✅ Static processWeb called with:', { collection_name, url });
	return {
		status: 'success',
...
export const processWebSearch = async (
	...
	// Static implementation - return null (no search results)
	console.log('✅ Static processWebSearch called with:', { query, collection_name });
	return null;
};
