...
<div class="min-w-[4.5rem] bg-gray-50 dark:bg-gray-950 flex gap-2.5 flex-col pt-8">
	...
	<div class="flex justify-center relative group">
		...
		>
			<div
				class="size-10 {selected === '' ? 'rounded-2xl' : 'rounded-full'} bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-lg font-bold"
			>
				S
			</div>
		</button>
